...
class BazaSeeder extends Seeder{
    ...
    public function run(){
		...
		Zahtev::create( array( 'studentID' => 1, 'Svedočanstvo' ) );
		Zahtev::create( array( 'studentID' => 2, 'Diploma' ) );
		Zahtev::create( array( 'studentID' => 3, 'Uverenje za zdravstvenu zaštitu' ) );
		Zahtev::create( array( 'studentID' => 4, 'Uverenje za gradski prevoz' ) );
		
		Uplata::create( array( 'studentID' => 1, 'Prijava ispita u vanrednom roku', '3100.00' ) );
		Uplata::create( array( 'studentID' => 1, 'Prijava ispita u vanrednom roku', '3100.00' ) );
		Uplata::create( array( 'studentID' => 2, 'Rata za školarinu', '22000.00' ) );
		Uplata::create( array( 'studentID' => 2, 'Zakasnela prijava ispita', '6600.00' ) );
		Uplata::create( array( 'studentID' => 3, 'Ispis sa fakulteta', '3000.00' ) );
		Uplata::create( array( 'studentID' => 4, 'Izdavanje diplome', '5400.00' ) );
