    ...
    <div class="btn-2 clr-red">
            ...
            <div class="pay">
                <a href="#"><h4><span class="icon-download"></span>pdf uplatnice</h4></a>
                <a href="#"><h4>plati</h4></a>
            </div>
    <div class="pay">
        <a target="blank" href="http://uplatnica.rs/uplatnica.php?uplatilac={{ Auth::user()->ime }}%20{{ Auth::user()->prezime }}&svrha=racun:elfak35A1&primalac=Elektronski%20Fakultet%20Nis&sifra=189&valuta=RSD&iznos=&iznos_dec=&racun=160-332233-93&model=&poziv="><h4><span></span>pdf uplatnice</h4></a>
